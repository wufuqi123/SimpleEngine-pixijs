...
let fragRain = `// Heartfelt - by Martijn Steinrucken aka BigWings - 2017
...
void main()
{
    ...
    vec3 col = texture2D(uSampler, UV+n).rgb;
...
export class RainFilter extends Filter {
  ...
  private updateiResolution() {
    ...
    this.uniforms["texSize"] = new Float32Array([this.width, this.height]);
  }
  /**
   * 从0开始的毫秒数
   */
